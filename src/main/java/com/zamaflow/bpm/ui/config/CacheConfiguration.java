package com.zamaflow.bpm.ui.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zamaflow.bpm.ui.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zamaflow.bpm.ui.repository.UserRepository.USERS_BY_EMAIL_CACHE);
