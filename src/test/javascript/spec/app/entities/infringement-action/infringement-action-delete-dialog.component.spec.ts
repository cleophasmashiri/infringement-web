...
describe('Component Tests', () => {
  describe('InfringementAction Management Delete Component', () => {
    let comp: InfringementActionDeleteDialogComponent;
    let fixture: ComponentFixture<InfringementActionDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [InfringementActionDeleteDialogComponent],
      })
        .overrideTemplate(InfringementActionDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(InfringementActionDeleteDialogComponent);
