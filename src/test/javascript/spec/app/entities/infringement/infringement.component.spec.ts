...
describe('Component Tests', () => {
  describe('Infringement Management Component', () => {
    let comp: InfringementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InfringementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.infringements && comp.infringements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
